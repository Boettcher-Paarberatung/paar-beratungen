...
if (
	$cmsmasters_option['psychology-help' . '_profile_post_cat'] || 
	$cmsmasters_option['psychology-help' . '_profile_post_comment'] || 
	(
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	if ($cmsmasters_profile_title == 'true') {
		echo '<header class="cmsmasters_profile_header entry-header">';
			psychology_help_profile_title_nolink(get_the_ID(), 'h1', $cmsmasters_profile_subtitle, 'h6');
		echo '</header>';
	}
		...
		echo '<div class="profile_sidebar">';
			...
			if ($profile_details == 'true') {
				echo '<div class="profile_details entry-meta">' . 
					...
					psychology_help_get_profile_features('details', $cmsmasters_profile_features, false, 'h3', true);
					
					psychology_help_get_profile_category(get_the_ID(), 'pl-categs', 'post');
					
					psychology_help_get_profile_comments('post');
					
					psychology_help_get_profile_like('post');
					
				echo '</div>';
			}
			
			
			psychology_help_get_profile_features('features', $cmsmasters_profile_features_one, $cmsmasters_profile_features_one_title, 'h3', true);
			
			psychology_help_get_profile_features('features', $cmsmasters_profile_features_two, $cmsmasters_profile_features_two_title, 'h3', true);
			
			psychology_help_get_profile_features('features', $cmsmasters_profile_features_three, $cmsmasters_profile_features_three_title, 'h3', true);
			
			
			psychology_help_profile_social_icons($cmsmasters_profile_social, esc_html__('Socials', 'psychology-help'), 'h3');
