...
add_action('admin_menu', 'psychology_help_add_menu');
add_action('admin_init', 'psychology_help_register_settings');


psychology_help_locate_template(CMSMASTERS_SETTINGS . '/inc/cmsmasters-helper-functions.php', true);
psychology_help_locate_template(CMSMASTERS_SETTINGS . '/cmsmasters-theme-settings-general.php', true);
psychology_help_locate_template(CMSMASTERS_SETTINGS . '/cmsmasters-theme-settings-font.php', true);
psychology_help_locate_template(CMSMASTERS_SETTINGS . '/cmsmasters-theme-settings-color.php', true);
psychology_help_locate_template(CMSMASTERS_SETTINGS . '/cmsmasters-theme-settings-element.php', true);
psychology_help_locate_template(CMSMASTERS_SETTINGS . '/cmsmasters-theme-settings-single.php', true);
psychology_help_locate_template(CMSMASTERS_SETTINGS . '/cmsmasters-theme-settings-demo.php', true);


function psychology_help_get_settings() {
	$output = array();
	
	
	$page = psychology_help_get_admin_page();
	...
	case 'cmsmasters-settings':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'psychology-help';
		$cmsmasters_settings_page_title = esc_html__('Theme General Settings', 'psychology-help');
		$cmsmasters_page_sections = psychology_help_options_general_sections();
		$cmsmasters_page_fields = psychology_help_options_general_fields();
		$cmsmasters_page_tabs = psychology_help_options_general_tabs();
	...
	case 'cmsmasters-settings' . '-font':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'psychology-help' . '_font';
		$cmsmasters_settings_page_title = esc_html__('Theme Fonts Settings', 'psychology-help');
		$cmsmasters_page_sections = psychology_help_options_font_sections();
		$cmsmasters_page_fields = psychology_help_options_font_fields();
		$cmsmasters_page_tabs = psychology_help_options_font_tabs();
	...
	case 'cmsmasters-settings' . '-color':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'psychology-help' . '_color';
		$cmsmasters_settings_page_title = esc_html__('Theme Color Schemes', 'psychology-help');
		$cmsmasters_page_sections = psychology_help_options_color_sections();
		$cmsmasters_page_fields = psychology_help_options_color_fields();
		$cmsmasters_page_tabs = psychology_help_options_color_tabs();
	...
	case 'cmsmasters-settings' . '-element':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'psychology-help' . '_element';
		$cmsmasters_settings_page_title = esc_html__('Theme Elements Settings', 'psychology-help');	
		$cmsmasters_page_sections = psychology_help_options_element_sections();
		$cmsmasters_page_fields = psychology_help_options_element_fields();
		$cmsmasters_page_tabs = psychology_help_options_element_tabs();
	...
	case 'cmsmasters-settings' . '-single':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'psychology-help' . '_single';
		$cmsmasters_settings_page_title = esc_html__('Theme Single Posts Settings', 'psychology-help');
		$cmsmasters_page_sections = psychology_help_options_single_sections();
		$cmsmasters_page_fields = psychology_help_options_single_fields();
		$cmsmasters_page_tabs = psychology_help_options_single_tabs();
	...
	case 'cmsmasters-settings' . '-demo':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'psychology-help' . '_demo';
		$cmsmasters_settings_page_title = esc_html__('Theme Settings Import/Export', 'psychology-help');
		$cmsmasters_page_sections = psychology_help_options_demo_sections();
		$cmsmasters_page_fields = psychology_help_options_demo_fields();
		$cmsmasters_page_tabs = psychology_help_options_demo_tabs();
...
function psychology_help_create_settings_field($args = array()) {
	$defaults = array( 
		'id' => 		'default_field', 
		'title' => 		esc_html__('Default Field', 'psychology-help'), 
		'desc' => 		esc_html__('This is a default description.', 'psychology-help'), 
		'std' => 		'', 
		'type' => 		'text', 
...
function psychology_help_register_settings() {
	$settings_output = psychology_help_get_settings();
	...
	register_setting($cmsmasters_option_name, $cmsmasters_option_name, 'psychology_help_validate_options');
	
	
	if (!empty($settings_output['cmsmasters_page_sections'])) {
		foreach ($settings_output['cmsmasters_page_sections'] as $id => $title) {
			add_settings_section($id, $title, 'psychology_help_section_fn', __FILE__);
		}
	}
	...
	if (!empty($settings_output['cmsmasters_page_fields'])) {
		foreach ($settings_output['cmsmasters_page_fields'] as $option) {
			psychology_help_create_settings_field($option);
		}
	}
...
function psychology_help_settings_scripts() {
	...
	wp_localize_script('cmsmasters_theme_settings_js', 'cmsmasters_setting', array( 
		...
		'remove' => 						esc_attr__('Remove', 'psychology-help'), 
		'remove_sidebar' => 				esc_html__('Do you really want to remove this sidebar?', 'psychology-help'), 
		'find' => 							esc_attr__('Find icons', 'psychology-help'), 
		'remove_icon' => 					esc_html__('Do you really want to remove this social icon?', 'psychology-help'), 
		'theme_uri' => 						get_template_directory_uri(), 
		'shortname' => 						'psychology-help', 
		'done' => 							esc_html__('All theme settings were imported successfully.', 'psychology-help'), 
		'fail' => 							esc_html__("Error on page!!!\nPlease reload page and try again.", 'psychology-help'),  
...
function psychology_help_add_menu() {
	$settings_output = psychology_help_get_settings();
	...
	$add_menu_p( 
		esc_attr__('Theme Settings', 'psychology-help'), 
		esc_attr__('Theme Settings', 'psychology-help'), 
		'manage_options', 
		'cmsmasters-settings', 
		'psychology_help_settings_page_fn', 
		'' 
	);
	...
	$cmsmasters_settings_general = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme General Settings', 'psychology-help'), 
		esc_attr__('General', 'psychology-help'), 
		'manage_options', 
		'cmsmasters-settings', 
		'psychology_help_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_general, 'psychology_help_settings_scripts');
	
	
	$cmsmasters_settings_font = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Fonts Settings', 'psychology-help'), 
		esc_attr__('Fonts', 'psychology-help'), 
		'manage_options', 
		'cmsmasters-settings' . '-font', 
		'psychology_help_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_font, 'psychology_help_settings_scripts');
	
	
	$cmsmasters_settings_color = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Color Schemes', 'psychology-help'), 
		esc_attr__('Colors', 'psychology-help'), 
		'manage_options', 
		'cmsmasters-settings' . '-color', 
		'psychology_help_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_color, 'psychology_help_settings_scripts');
	
	
	$cmsmasters_settings_element = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Elements Settings', 'psychology-help'), 
		esc_attr__('Elements', 'psychology-help'), 
		'manage_options', 
		'cmsmasters-settings' . '-element', 
		'psychology_help_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_element, 'psychology_help_settings_scripts');
	
	
	$cmsmasters_settings_single = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Single Posts Settings', 'psychology-help'), 
		esc_attr__('Single Posts', 'psychology-help'), 
		'manage_options', 
		'cmsmasters-settings' . '-single', 
		'psychology_help_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_single, 'psychology_help_settings_scripts');
	
	
	$cmsmasters_settings_demo = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Settings Import/Export', 'psychology-help'), 
		esc_attr__('Import/Export', 'psychology-help'), 
		'manage_options', 
		'cmsmasters-settings' . '-demo', 
		'psychology_help_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_demo, 'psychology_help_settings_scripts');
}


function psychology_help_section_fn($desc) {
	$tab = psychology_help_get_the_tab();
...
function psychology_help_settings_page_fn() {
	$settings_output = psychology_help_get_settings();
	$current_tab = psychology_help_get_the_tab();
	
	echo '<div class="wrap">';
	
	psychology_help_settings_page_header();
	...
	if ($current_tab != 'wpml') {
		...
		'<p class="submit-top">' . 
			(($current_tab != 'import' && $current_tab != 'export') ? '<input name="submit-top" type="submit" class="button button-primary button-large" value="' . esc_attr__('Save Changes', 'psychology-help') . '" />' : '') . 
		'</p>';
		...
		echo '<p class="submit">' . 
				(($current_tab != 'import' && $current_tab != 'export') ? '<input name="submit" type="submit" class="button button-primary button-large" value="' . esc_attr__('Save Changes', 'psychology-help') . '" />' : (($current_tab == 'import') ? '<input name="import" type="button" class="button button-primary button-large cmsmasters-demo-import" value="' . esc_attr__('Import Settings', 'psychology-help') . '" />' : '')) . 
			'</p>' . 
		'</form>';
	} else {
		do_settings_sections(__FILE__);
...
function psychology_help_form_field_fn($args = array()) {
	extract($args);
	...
	case 'upload':
		...
		echo '<div class="cmsmasters_upload_parent cmsmasters_select_parent">' . 
			'<input type="button" id="cmsmasters_upload_' . $id . '_button" class="cmsmasters_upload_button button button-large" value="' . esc_attr__('Choose Image', 'psychology-help') . '" data-title="' . esc_attr__('Choose Image', 'psychology-help') . '" data-button="' . esc_attr__('Insert Image', 'psychology-help') . '" data-id="cmsmasters-media-select-frame-' . $id . '" data-classes="media-frame cmsmasters-media-select-frame' . ((!isset($description)) ? ' cmsmasters-frame-no-description' : '') . ((!isset($caption)) ? ' cmsmasters-frame-no-caption' : '') . ((!isset($align)) ? ' cmsmasters-frame-no-align' : '') . ((!isset($link)) ? ' cmsmasters-frame-no-link' : '') . ((!isset($size)) ? ' cmsmasters-frame-no-size' : '') . '" data-library="image" data-type="' . $frame . '"' . (($frame == 'post') ? ' data-state="insert"' : '') . ' data-multiple="' . $multiple . '" />' . 
			'<div class="cmsmasters_upload"' . (($image != '') ? ' style="display:block;"' : '') . '>' . 
				'<img src="' . (($image != '') ? $image : '') . '" class="cmsmasters_preview_image" />' . 
				'<a href="#" class="cmsmasters_upload_cancel admin-icon-remove" title="' . esc_attr__('Remove', 'psychology-help') . '"></a>' . 
			'</div>' . 
	...
	case 'typorgaphy':
		...
		if ($system_font) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				foreach (psychology_help_system_fonts_list() as $key => $value) {
					echo '<option value="' . esc_attr($key) . '"' . (($options[$id . '_system_font'] == $key) ? ' selected="selected"' : '') . '>' . esc_html($value) .'</option>';
				}
				
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_system_font">' . esc_html__('System Font', 'psychology-help') . '</label>' . 
			'</div>';
		}
		...
		if ($google_font) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_google_font">' . esc_html__('Google Font', 'psychology-help') . '</label>' . 
			'</div>';
		}
		...
		if ($font_size) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				' &nbsp; ' . 
				'<label for="' . $id . '_font_size_number">' . esc_html__('Font Size', 'psychology-help') . ' <em>(' . esc_html__('in pixels', 'psychology-help') . ')</em></label>' . 
			'</div>';
		}
		...
		if ($line_height) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				' &nbsp; ' . 
				'<label for="' . $id . '_line_height_number">' . esc_html__('Line Height', 'psychology-help') . ' <em>(' . esc_html__('in pixels', 'psychology-help') . ')</em></label>' . 
			'</div>';
		}
		...
		if ($font_weight) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_font_weight">' . esc_html__('Font Weight', 'psychology-help') . '</label>' . 
			'</div>';
		}
		...
		if ($font_style) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_font_style">' . esc_html__('Font Style', 'psychology-help') . '</label>' . 
			'</div>';
		}
		...
		if ($text_transform) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				foreach (psychology_help_text_transform_list() as $key => $value) {
					echo '<option value="' . esc_attr($key) . '"' . (($options[$id . '_text_transform'] == $key) ? ' selected="selected"' : '') . '>' . esc_html($value) .'</option>';
				}
				
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_text_transform">' . esc_html__('Text Transform', 'psychology-help') . '</label>' . 
			'</div>';
		}
		...
		if ($text_decoration) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				foreach (psychology_help_text_decoration_list() as $key => $value) {
					echo '<option value="' . esc_attr($key) . '"' . (($options[$id . '_text_decoration'] == $key) ? ' selected="selected"' : '') . '>' . esc_html($value) .'</option>';
				}
				
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_text_decoration">' . esc_html__('Text Decoration', 'psychology-help') . '</label>' . 
			'</div>';
		}
	...
	case 'sidebar':
		...
		'<div class="sidebar_management">' . 
			'<p>' . 
				...
				'<input class="button" type="button" id="add_sidebar" value="' . esc_attr__('Add Sidebar', 'psychology-help') . '" />' . 
			'</p>' . 
			'<div></div>' . 
			'<ul>';
	...
	case 'social':
		...
		'<div class="icon_management">' . 
			'<p>' . 
				...
				'<input id="' . $id . '_button" class="cmsmasters_icon_choose_button button" type="button" value="' . esc_attr__('Choose icon', 'psychology-help') . '" />' . 
				'<a href="#" class="cmsmasters_remove_icon admin-icon-remove" title="' . esc_attr__('Cancel changes', 'psychology-help') . '"></a>' . 
			'</p>' . 
			...
			'<span class="icon_upload_link" style="display:none;">' . 
				'<label for="new_icon_link">' . 
					...
					esc_html__('Icon Link', 'psychology-help') . 
				'</label>' . 
				'<label for="new_icon_title">' . 
					'<input class="all-options" type="text" id="new_icon_title" /> ' . 
					esc_html__('Icon Title', 'psychology-help') . 
				'</label>' . 
				'<label for="new_icon_target">' . 
					'<input type="checkbox" id="new_icon_target" value="true" /> ' . 
					esc_html__('Open link in a new tab/window?', 'psychology-help') . 
				'</label>' . 
			'</span>' . 
			'<span class="cl"></span>' . 
			'<input class="button button-primary" type="button" id="add_icon" value="' . esc_attr__('Add Icon', 'psychology-help') . '" />' . 
			'<input class="button button-primary" type="button" id="edit_icon" value="' . esc_attr__('Save Icon', 'psychology-help') . '" />' . 
			'<ul>';
			...
			if (isset($options[$id]) && is_array($options[$id])) {
				foreach($options[$id] as $icon) {
					...
					echo '<li>' . 
						...
						'</div>' . 
						'<a href="#" class="icon_del admin-icon-remove" title="' . esc_attr__('Remove', 'psychology-help') . '"></a> ' . 
...
function psychology_help_validate_options($input) {
	$valid_input = array();
	...
	foreach ($options as $option) {
		...
		case 'text':
			...
			case 'numeric':
				...
				$valid_input[$option['id']] = (is_numeric($input[$option['id']])) ? $input[$option['id']] : esc_html__('Expecting a Numeric value!', 'psychology-help');
				
				if (is_numeric($input[$option['id']]) == false) {
					add_settings_error(
						$option['id'],
						'psychology-help' . '_txt_numeric_error',
						esc_html__('Expecting a Numeric value! Please fix.', 'psychology-help'),
						'error'
					);
				}
			...
			case 'multinumeric':
				...
				if ($input[$option['id']] != '') {
					$valid_input[$option['id']] = (preg_match('/^-?\d+(?:,\s?-?\d+)*$/', $input[$option['id']]) == 1) ? $input[$option['id']] : esc_html__('Expecting comma separated numeric values', 'psychology-help');
				} else {
				...
				if ($input[$option['id']] != '' && preg_match('/^-?\d+(?:,\s?-?\d+)*$/', $input[$option['id']]) != 1) {
					add_settings_error(
						$option['id'],
						'psychology-help' . '_txt_multinumeric_error',
						esc_html__('Expecting comma separated numeric values! Please fix.','psychology-help'),
						'error'
					);
				}
			...
			case 'email':
				...
				if ($input[$option['id']] != '') {
					$valid_input[$option['id']] = (is_email($input[$option['id']]) !== false) ? $input[$option['id']] : esc_html__('Invalid email! Please re-enter!', 'psychology-help');
				} elseif ($input[$option['id']] == '') {
					$valid_input[$option['id']] = esc_html__('This setting field cannot be empty! Please enter a valid email address.', 'psychology-help');
				}
				
				if (is_email($input[$option['id']]) == false || $input[$option['id']] == '') {
					add_settings_error(
						$option['id'],
						'psychology-help' . '_txt_email_error',
						esc_html__('Please enter a valid email address.', 'psychology-help'),
						'error'
					);
				}
		...
		case 'number':
			$input[$option['id']] = trim($input[$option['id']]);
			$valid_input[$option['id']] = (is_numeric($input[$option['id']])) ? $input[$option['id']] : esc_html__('Number!', 'psychology-help');
...
function theme_admin_bar_render() {
	...
	$wp_admin_bar->add_menu(array( 
		'id' => 'psychology-help' . '_options', 
		'title' => esc_attr__('Theme Settings', 'psychology-help'), 
		'href' => esc_url(admin_url('admin.php?page=cmsmasters-settings')) 
	));
	
	
	$wp_admin_bar->add_menu(array( 
		'parent' => 'psychology-help' . '_options', 
		'id' => 'psychology-help' . '_theme_settings', 
		'title' => esc_attr__('General', 'psychology-help'), 
		'href' => esc_url(admin_url('admin.php?page=cmsmasters-settings')) 
	));
	
	$wp_admin_bar->add_menu(array( 
		'parent' => 'psychology-help' . '_options', 
		'id' => 'psychology-help' . '_theme_settings_font', 
		'title' => esc_attr__('Fonts', 'psychology-help'), 
		'href' => esc_url(admin_url('admin.php?page=cmsmasters-settings-font')) 
	));
	
	$wp_admin_bar->add_menu(array( 
		'parent' => 'psychology-help' . '_options', 
		'id' => 'psychology-help' . '_theme_settings_color', 
		'title' => esc_attr__('Colors', 'psychology-help'), 
		'href' => esc_url(admin_url('admin.php?page=cmsmasters-settings-color')) 
	));
	
	$wp_admin_bar->add_menu(array( 
		'parent' => 'psychology-help' . '_options', 
		'id' => 'psychology-help' . '_theme_settings_element', 
		'title' => esc_attr__('Elements', 'psychology-help'), 
		'href' => esc_url(admin_url('admin.php?page=cmsmasters-settings-element')) 
	));
	
	$wp_admin_bar->add_menu(array( 
		'parent' => 'psychology-help' . '_options', 
		'id' => 'psychology-help' . '_theme_settings_single', 
		'title' => esc_attr__('Single', 'psychology-help'), 
...
function psychology_help_show_msg($message, $msgclass = 'info') {
	echo '<div id="message" class="' . $msgclass . '">' . $message . '</div>';
}


function psychology_help_admin_msgs() {
	global $pagenow;
	...
	if ($pagenow == 'admin.php' && current_user_can('manage_options') && $cmsmasters_settings_pg !== false && !empty($set_errors)) {
		if ($set_errors[0]['code'] == 'settings_updated' && isset($_GET['settings-updated'])) {
			psychology_help_show_msg('<p><strong>' . $set_errors[0]['message'] . '</strong></p>', 'updated');
		} else {
			foreach ($set_errors as $set_error) {
				psychology_help_show_msg('<p class="setting-error-message" title="' . esc_attr($set_error['setting']) . '">' . $set_error['message'] . '</p>', 'error');
			}
		}
	}
}

add_action('admin_notices', 'psychology_help_admin_msgs');


function psychology_help_add_global_options() {
	$cmsmasters_option_names = array( 
		array( 
			'cmsmasters_options_' . 'psychology-help' . '_general', 
			psychology_help_options_general_fields('general') 
		), 
		array( 
			'cmsmasters_options_' . 'psychology-help' . '_bg', 
			psychology_help_options_general_fields('bg') 
		), 
		array( 
			'cmsmasters_options_' . 'psychology-help' . '_header', 
			psychology_help_options_general_fields('header') 
		), 
		array( 
			'cmsmasters_options_' . 'psychology-help' . '_content', 
			psychology_help_options_general_fields('content') 
		), 
		array( 
			'cmsmasters_options_' . 'psychology-help' . '_footer', 
			psychology_help_options_general_fields('footer') 
		), 
		array( 
			'cmsmasters_options_' . 'psychology-help' . '_font_content', 
			psychology_help_options_font_fields('content') 
		), 
		array( 
			'cmsmasters_options_' . 'psychology-help' . '_font_link', 
			psychology_help_options_font_fields('link') 
		), 
		array( 
			'cmsmasters_options_' . 'psychology-help' . '_font_nav', 
			psychology_help_options_font_fields('nav') 
		), 
		array( 
			'cmsmasters_options_' . 'psychology-help' . '_font_heading', 
			psychology_help_options_font_fields('heading') 
		), 
		array( 
			'cmsmasters_options_' . 'psychology-help' . '_font_other', 
			psychology_help_options_font_fields('other') 
		), 
		array( 
			'cmsmasters_options_' . 'psychology-help' . '_element_sidebar', 
			psychology_help_options_element_fields('sidebar') 
		), 
		array( 
			'cmsmasters_options_' . 'psychology-help' . '_element_icon', 
			psychology_help_options_element_fields('icon') 
		), 
		array( 
			'cmsmasters_options_' . 'psychology-help' . '_element_lightbox', 
			psychology_help_options_element_fields('lightbox') 
		), 
		array( 
			'cmsmasters_options_' . 'psychology-help' . '_element_sitemap', 
			psychology_help_options_element_fields('sitemap') 
		), 
		array( 
			'cmsmasters_options_' . 'psychology-help' . '_element_error', 
			psychology_help_options_element_fields('error') 
		), 
		array( 
			'cmsmasters_options_' . 'psychology-help' . '_element_code', 
			psychology_help_options_element_fields('code') 
		), 
		array( 
		...
		array( 
			...
			psychology_help_options_single_fields('post') 
		), 
		array( 
			'cmsmasters_options_' . 'psychology-help' . '_single_project', 
			psychology_help_options_single_fields('project') 
		), 
		array( 
			'cmsmasters_options_' . 'psychology-help' . '_single_profile', 
			psychology_help_options_single_fields('profile') 
		), 
		array( 
			'cmsmasters_options_' . 'psychology-help' . '_single_campaign', 
			psychology_help_options_single_fields('campaign') 
		) 
	);
	
	foreach (psychology_help_all_color_schemes_list() as $key => $value) {
		array_push($cmsmasters_option_names, array( 
			'cmsmasters_options_' . 'psychology-help' . '_color_' . $key, 
			psychology_help_options_color_fields($key) 
		));
	}
		...
		if ($cmsmasters_option_name[1] !== '') {
			foreach ($cmsmasters_option_name[1] as $selected_option) {
				if ( 
					...
					$selected_option['id'] !== 'psychology-help' . '_social_icons' 
				) {
...
function psychology_help_get_global_options() {
	...
	foreach (psychology_help_all_color_schemes_list() as $key => $value) {
		array_push($cmsmasters_option_names, 'cmsmasters_options_' . 'psychology-help' . '_color_' . $key);
	}
