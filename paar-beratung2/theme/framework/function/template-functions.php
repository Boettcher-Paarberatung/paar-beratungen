...
function psychology_help_get_page_classes($cmsmasters_option, $classes = false) {
	$browser = new Browser();
	if (
	...
	echo 'cmsmasters_' . $cmsmasters_option['psychology-help' . '_theme_layout'] . ' ';

	if ($cmsmasters_option['psychology-help' . '_fixed_header']) {
		echo 'fixed_header ';
	}

	if ($cmsmasters_option['psychology-help' . '_header_top_line']) {
		echo 'enable_header_top ';
	}

	if ($cmsmasters_option['psychology-help' . '_header_styles'] != 'default') {
		echo 'enable_header_bottom ';
	}

	if ($cmsmasters_option['psychology-help' . '_header_styles'] == 'r_nav') {
		echo 'enable_header_right ';
	}

	if ($cmsmasters_option['psychology-help' . '_header_styles'] == 'c_nav') {
	...
	if ($cmsmasters_header_overlaps == '') {
		$cmsmasters_header_overlaps = $cmsmasters_option['psychology-help' . '_header_overlaps'];
	}
...
function psychology_help_header_top($cmsmasters_option) {
	if ($cmsmasters_option['psychology-help' . '_header_top_line']) {
		echo '<div class="header_top" data-height="' . esc_attr($cmsmasters_option['psychology-help' . '_header_top_height']) . '">' . 
			'<div class="header_top_outer">' . 
				'<div class="header_top_inner">';
				
					if (
						$cmsmasters_option['psychology-help' . '_header_top_line_add_cont'] !== 'none' || 
						(
							CMSMASTERS_DONATIONS && 
							isset($cmsmasters_option['psychology-help' . '_header_top_line_donations_but']) && 
							$cmsmasters_option['psychology-help' . '_header_top_line_donations_but'] &&
							isset($cmsmasters_option['psychology-help' . '_header_top_line_donations_but_text']) && 
							$cmsmasters_option['psychology-help' . '_header_top_line_donations_but_text'] != '' 
						)
					) {
						...
						if (
							$cmsmasters_option['psychology-help' . '_header_top_line_add_cont'] == 'social' && 
							isset($cmsmasters_option['psychology-help' . '_social_icons'])
						) {
							psychology_help_social_icons();
						} elseif (
							$cmsmasters_option['psychology-help' . '_header_top_line_add_cont'] == 'nav' && 
						...
						if (
							...
							echo '<a href="' . esc_url(get_permalink($cmsmasters_donations_form_page)) . '" class="header_top_donation_but"><span>' . esc_html($cmsmasters_option['psychology-help' . '_header_top_line_donations_but_text']) . '</span></a>';
						}
					...
					if ($cmsmasters_option['psychology-help' . '_header_top_line_short_info'] !== '') {
						echo '<div class="header_top_left">' . 
							'<div class="meta_wrap">' . 
								stripslashes($cmsmasters_option['psychology-help' . '_header_top_line_short_info']) . 
							'</div>' . 
						'</div>';
					} 
...
function psychology_help_header_mid($cmsmasters_option) {
	echo '<div class="header_mid" data-height="' . esc_attr($cmsmasters_option['psychology-help' . '_header_mid_height']) . '">' . 
		'<div class="header_mid_outer">' .
			'<div class="header_mid_inner">' . 
				'<div class="logo_wrap">';
				
					psychology_help_logo();
			...
			if (
				CMSMASTERS_DONATIONS && 
				isset($cmsmasters_option['psychology-help' . '_header_donations_but']) && 
				$cmsmasters_option['psychology-help' . '_header_donations_but'] && 
				isset($cmsmasters_option['psychology-help' . '_header_donations_but_text']) && 
				$cmsmasters_option['psychology-help' . '_header_donations_but_text'] != '' && 
				$cmsmasters_option['psychology-help' . '_header_styles'] != 'default' && 
				$cmsmasters_option['psychology-help' . '_header_styles'] != 'c_nav'
			) {
				$cmsmasters_donations_form_page = get_option('cmsmasters_donations_form_page');
					...
					'<div class="header_donation_but_wrap_inner">' . 
						'<div class="header_donation_but">' . 
							'<a href="' . esc_url(get_permalink($cmsmasters_donations_form_page)) . '" class="cmsmasters_button">' . 
								'<span>' . esc_html($cmsmasters_option['psychology-help' . '_header_donations_but_text']) . '</span>' . 
							'</a>' . 
						'</div>' . 
					'</div>' . 
				'</div>';
			...
			if (CMSMASTERS_WOOCOMMERCE) {
				echo '<div class="cmsmasters_dynamic_cart_wrap">';
					...
					psychology_help_woocommerce_cart_dropdown(); 
			...
			if (
				$cmsmasters_option['psychology-help' . '_header_search'] && 
				$cmsmasters_option['psychology-help' . '_header_styles'] != 'c_nav'
			) {
			...
			if (
				...
				if (
					$cmsmasters_option['psychology-help' . '_header_add_cont'] == 'cust_html' && 
					$cmsmasters_option['psychology-help' . '_header_add_cont_cust_html'] !== ''
				) {
				
				echo '<div class="slogan_wrap">' . 
						'<div class="slogan_wrap_inner">' . 
							'<div class="slogan_wrap_text">' . 
								stripslashes($cmsmasters_option['psychology-help' . '_header_add_cont_cust_html']) . 
							'</div>' . 
						'</div>' . 
					'</div>';
				} elseif (
					$cmsmasters_option['psychology-help' . '_header_add_cont'] == 'social' && 
					isset($cmsmasters_option['psychology-help' . '_social_icons'])
				) {
					psychology_help_social_icons();
				}
				...
				'<div class="mid_nav_wrap">' . 
					'<nav role="navigation">';
						...
						$nav_args = array( 
							...
							'link_before' => 		'<span class="nav_item_wrap">', 
							'link_after' => 		'</span>', 
							'fallback_cb' => 		'psychology_help_fallback_menu' 
						);
...
function psychology_help_header_bot($cmsmasters_option) {
	if ($cmsmasters_option['psychology-help' . '_header_styles'] != 'default') {
		echo '<div class="header_bot" data-height="' . esc_attr($cmsmasters_option['psychology-help' . '_header_bot_height']) . '">' . 
			'<div class="header_bot_outer">' . 
				'<div class="header_bot_inner">' . 
					'<div class="resp_bot_nav_wrap">' . 
						'<div class="resp_bot_nav_outer">' . 
							'<a class="responsive_nav resp_bot_nav" href="javascript:void(0);"><span></span></a>' .
						'</div>' . 
					'</div>' . 
...
function psychology_help_logo() {
	...
	if ($cmsmasters_option['psychology-help' . '_logo_type'] == 'text') {
		if ($cmsmasters_option['psychology-help' . '_logo_title'] != '') {
			$blog_title = stripslashes($cmsmasters_option['psychology-help' . '_logo_title']);
		} else {
			$blog_title = (get_bloginfo('name')) ? get_bloginfo('name') : 'Psychology Help';
		}
		
		
		if ($cmsmasters_option['psychology-help' . '_logo_subtitle'] != '') {
			$blog_descr = stripslashes($cmsmasters_option['psychology-help' . '_logo_subtitle']);
		} else {
			$blog_descr = (get_bloginfo('description')) ? get_bloginfo('description') : esc_html__('Default Logo Subtitle', 'psychology-help');
		}
		...
		echo '<a href="' . esc_url(home_url('/')) . '" title="' . esc_attr($blog_title) . '" class="logo">' . "\n\t" . 
			...
			'<span class="logo_text_wrap">' . 
				...
				($cmsmasters_option['psychology-help' . '_logo_subtitle'] ? '<span class="title_text">' . esc_html($blog_descr) . '</span>' : '') . 
			'</span>' . 
		'</a>';
	} else {
		...
		if ($cmsmasters_option['psychology-help' . '_logo_url'] == '') {
			echo '<a href="' . esc_url(home_url('/')) . '" title="' . esc_attr(get_bloginfo('name')) . '" class="logo">' . "\n\t" . 
				...
				'<img class="logo_retina" src="' . esc_url(get_template_directory_uri()) . '/img/logo_retina.png" alt="' . esc_attr(get_bloginfo('name')) . '" width="281" height="50" />' . "\r" . 
			'</a>' . "\n";
		} else {
			$logo_img = explode('|', $cmsmasters_option['psychology-help' . '_logo_url']);
			...
			if ($cmsmasters_option['psychology-help' . '_logo_url_retina'] != '') {
				$logo_img_retina = explode('|', $cmsmasters_option['psychology-help' . '_logo_url_retina']);
			
				if (is_numeric($logo_img_retina[0])) {
					$logo_img_retina_url = wp_get_attachment_image_src((int) $logo_img_retina[0], 'full');
				}
				
				$logo_img_retina_width = ((is_numeric($logo_img_retina[0])) ? ((int) $logo_img_retina_url[1] / 2) : '281');
				
				$logo_img_retina_height = ((is_numeric($logo_img_retina[0])) ? ((int) $logo_img_retina_url[2] / 2) : '50');
...
/* Logo Styles */
function psychology_help_theme_logo_styles() {
	$cmsmasters_option = psychology_help_get_global_options();
	...
	if ($cmsmasters_option['psychology-help' . '_logo_type'] == 'text') {
		if ($cmsmasters_option['psychology-help' . '_logo_custom_color']) {
			$out .= "
		...
		$header_mid_height = (($cmsmasters_option['psychology-help' . '_header_mid_height'] !== '') ? $cmsmasters_option['psychology-help' . '_header_mid_height'] : '108');
...
function psychology_help_footer_logo($cmsmasters_option) {
	if (
		$cmsmasters_option['psychology-help' . '_footer_type'] == 'default' && 
		$cmsmasters_option['psychology-help' . '_footer_logo']
	) {
		...
		if ($cmsmasters_option['psychology-help' . '_footer_logo_url'] == '') {
			...
			$footer_logo_img = explode('|', $cmsmasters_option['psychology-help' . '_footer_logo_url']);
			...
			if ($cmsmasters_option['psychology-help' . '_footer_logo_url_retina'] != '') {
				$footer_logo_img_retina = explode('|', $cmsmasters_option['psychology-help' . '_footer_logo_url_retina']);
...
function psychology_help_get_footer_custom_html($cmsmasters_option) {
	if (
		(
			$cmsmasters_option['psychology-help' . '_footer_type'] == 'default' && 
			$cmsmasters_option['psychology-help' . '_footer_html'] !== ''
		) || (
			$cmsmasters_option['psychology-help' . '_footer_type'] == 'small' && 
			$cmsmasters_option['psychology-help' . '_footer_additional_content'] == 'text' && 
			$cmsmasters_option['psychology-help' . '_footer_html'] !== ''
		)
	) {
		echo '<div class="footer_custom_html">' . 
			do_shortcode(stripslashes($cmsmasters_option['psychology-help' . '_footer_html'])) . 
		'</div>';
	}
}
...
function psychology_help_get_footer_nav($cmsmasters_option) {
	if (
		has_nav_menu('footer') && 
		(
			(
				$cmsmasters_option['psychology-help' . '_footer_type'] == 'default' && 
				$cmsmasters_option['psychology-help' . '_footer_nav']
			) || (
				$cmsmasters_option['psychology-help' . '_footer_type'] == 'small' && 
				$cmsmasters_option['psychology-help' . '_footer_additional_content'] == 'nav'
			)
		)
	) {
		echo '<nav>';
...
function psychology_help_get_footer_social_icons($cmsmasters_option) {
	if (
		isset($cmsmasters_option['psychology-help' . '_social_icons']) && 
		(
			(
				$cmsmasters_option['psychology-help' . '_footer_type'] == 'default' && 
				$cmsmasters_option['psychology-help' . '_footer_social']
			) || (
				$cmsmasters_option['psychology-help' . '_footer_type'] == 'small' && 
				$cmsmasters_option['psychology-help' . '_footer_additional_content'] == 'social'
			)
		)
	) {
		psychology_help_social_icons();
...
function psychology_help_page_heading() {
	$cmsmasters_option = psychology_help_get_global_options();
	...
	if (
		...
		$cmsmasters_header_overlaps = $cmsmasters_option['psychology-help' . '_header_overlaps'] ? 'true' : 'false';
		
		$cmsmasters_heading_alignment = $cmsmasters_option['psychology-help' . '_heading_alignment'];
		$cmsmasters_heading_scheme = $cmsmasters_option['psychology-help' . '_heading_scheme'];
		
		$cmsmasters_breadcrumbs = $cmsmasters_option['psychology-help' . '_breadcrumbs'] ? 'true' : 'false';
	}
			...
			if ($cmsmasters_heading == 'custom') {
				...
				if (is_search()) {
					...
					if (!empty($wp_query->found_posts)) {
						echo sprintf(esc_html(_n('1 search result for: %2$s', '%1$d search results for: %2$s', $wp_query->found_posts, 'psychology-help')), $wp_query->found_posts, get_search_query());
					} else {
						echo sprintf(esc_html__('0 search results for: %s', 'psychology-help'), get_search_query());
					}
				} elseif (is_archive()) {
					if (is_author()) {
						if (get_the_author_meta('first_name') != '' || get_the_author_meta('last_name') != '') {
							echo sprintf(esc_html__('Author: %1$s (%2$s %3$s)', 'psychology-help'), '<span class="vcard">' . get_the_author() . '</span>', get_the_author_meta('first_name'), get_the_author_meta('last_name'));
						} else {
							echo sprintf(esc_html__('Author: %s', 'psychology-help'), '<span class="vcard">' . get_the_author() . '</span>');
						}
					} else {
...
/* Get Page Heading Function */
function psychology_help_theme_page_heading_styles() {
	$cmsmasters_option = psychology_help_get_global_options();
	...
	if (
		...
		$cmsmasters_heading_height = $cmsmasters_option['psychology-help' . '_heading_height'];
		$cmsmasters_heading_bg_color = $cmsmasters_option['psychology-help' . '_heading_bg_color'];
		$cmsmasters_heading_bg_img_enable = $cmsmasters_option['psychology-help' . '_heading_bg_image_enable'] ? 'true' : 'false';
		$cmsmasters_heading_bg_img = $cmsmasters_option['psychology-help' . '_heading_bg_image'];
		$cmsmasters_heading_bg_rep = $cmsmasters_option['psychology-help' . '_heading_bg_repeat'];
		$cmsmasters_heading_bg_att = $cmsmasters_option['psychology-help' . '_heading_bg_attachment'];
		$cmsmasters_heading_bg_size = $cmsmasters_option['psychology-help' . '_heading_bg_size'];
	}
...
function psychology_help_social_icons() {
	$cmsmasters_option = psychology_help_get_global_options();
...
<div class=\"social_wrap\">
	...
	foreach ($cmsmasters_option['psychology-help' . '_social_icons'] as $cmsmasters_social_icons) {
...
function psychology_help_thumb($cmsmasters_id, $type = 'post-thumbnail', $link = true, $group = false, $preload = true, $highImg = false, $fullwidth = true, $show = true, $attachment = false, $unique = false, $link_icon = false, $placeholder_icon = 'cmsmasters_theme_icon_image') {
	$args = array( 
...
function psychology_help_thumb_rollover($cmsmasters_id, $type = 'post-thumbnail', $rollover = true, $open_link = true, $group = false, $attachment_images = false, $attachment_video_type = false, $attachment_video_link = false, $attachment_video_links = false, $highImg = false, $show = true, $link_redirect = false, $link_url = false, $link_target = false, $placeholder_icon = 'cmsmasters_theme_icon_image') {
	...
	if ($rollover) {
		...
		if (
			...
			$out .= '<a ' . ($is_video_selfhosted ? $shv_out : 'href="' . ((!$attachment_video_link) ? esc_url($cmsmasters_image_link[0]) : $attachment_video_link) . '"') . ' rel="ilightbox[' . esc_attr($cmsmasters_id) . '_' . esc_attr($unique_id) . ']"' . (($link_redirect == 'true' && $link_target == 'true') ? ' target="_blank"' : '') . ' title="' . esc_attr($cmsmasters_title) . '" class="cmsmasters_image_link' . (($open_link) ? '' : ' no_open_link') . '"></a>';
		}
		
		
		if ($open_link) {
			$out .= '<a href="' . (($link_redirect == 'true' && $link_url != '') ? esc_url($link_url) : esc_url(get_permalink($cmsmasters_id))) . '"' . (($link_redirect == 'true' && $link_target == 'true') ? ' target="_blank"' : '') . ' title="' . esc_attr($cmsmasters_title) . '" class="cmsmasters_open_post_link">' . esc_html__('Read more', 'psychology-help') . '</a>';
		}
		
		$out .= '</div>';
	} elseif ($open_link) {
		$out .= '<div class="cmsmasters_img_rollover">' . 
			'<a href="' . (($link_redirect == 'true' && $link_url != '') ? esc_url($link_url) : esc_url(get_permalink($cmsmasters_id))) . '"' . (($link_redirect == 'true' && $link_target == 'true') ? ' target="_blank"' : '') . ' title="' . esc_attr($cmsmasters_title) . '" class="cmsmasters_open_post_link">' . esc_html__('Read more', 'psychology-help') . '</a>' . 
		'</div>';
	}
...
function psychology_help_thumb_small($cmsmasters_id, $type = 'post', $w = 100, $h = 100, $show = true) {
...
function psychology_help_get_comments($class = false, $show = false) { 
	$out = '';
	
	
	if (comments_open()) {
		$out .= '<span class="cmsmasters_comments' . ($class ? ' ' . $class : '') . '">' . 
			'<a class="cmsmasters_theme_icon_comment" href="' . esc_url(get_comments_link()) . '" title="' . esc_attr__('Comment on', 'psychology-help') . ' ' . esc_attr(get_the_title()) . '">' . 
...
function psychology_help_prev_next_posts() {
...
function psychology_help_sharing_box($title_box = false, $tag = 'h3') {
	...
	echo "<aside class=\"share_posts\">
		...
		<div class=\"share_posts_inner\">
			<a href=\"https://www.facebook.com/sharer/sharer.php?display=popup&u={$page_link}\">" . esc_html__('Facebook', 'psychology-help') . "</a>
			<a href=\"https://twitter.com/intent/tweet?text=" . urlencode(html_entity_decode(sprintf(esc_attr__("Check out '%s' on %s website", 'psychology-help'), $social_title, $website_name), ENT_QUOTES, 'UTF-8')) . "&url={$page_link}\">" . esc_html__('Twitter', 'psychology-help') . "</a>
			<a href=\"https://pinterest.com/pin/create/button/?url={$page_link}&media={$pinterest_img}&description={$social_title}\">" . esc_html__('Pinterest', 'psychology-help') . "</a>
		</div>
	</aside>
";
}
...
function psychology_help_author_box($title_box = false, $tag = 'h3', $author_tag = 'h4') {
	...
	if ($user_description) {
		...
		echo '<figure class="about_author_avatar">' . 
			get_avatar($user_email, 65, get_option('avatar_default')) . 
		'</figure>' . 
		...
		if ($user_url) {
			echo '<a href="' . esc_url($user_url) . '" title="' . esc_attr(get_the_author()) . ' ' . esc_attr__('website', 'psychology-help') . '" target="_blank">' . esc_html($user_url) . '</a>';
		}
...
function psychology_help_related($tag = 'h3', $box_type = false, $tgsarray = null, $items_number = 5, $pause_time = 5, $type = 'post', $taxonomy = null) {
	if ( 
		...
		echo "<aside class=\"cmsmasters_single_slider" . (($type == 'campaign') ? ' cmsmasters_single_slider_campaign' : '') . "\">
			...
			if ($type == 'post') {
				esc_html_e('More posts', 'psychology-help');
			} elseif ($type == 'campaign') {
				esc_html_e('More campaigns', 'psychology-help');
			} else {
				esc_html_e('More projects', 'psychology-help');
			}
			...
			if ($r_query->have_posts()) {
						...
						while ($r_query->have_posts()) : $r_query->the_post();
							echo "<div class=\"cmsmasters_single_slider_item\">
								<div class=\"cmsmasters_single_slider_item_outer\">";
									...
									psychology_help_thumb(get_the_ID(), 'cmsmasters-project-thumb', true, false, true, false, true, true, false, false, false, 'cmsmasters_theme_icon_image');
				...
				if ($type == 'post') {
					esc_html_e('No posts found', 'psychology-help');
				} elseif ($type == 'campaign') {
					esc_html_e('No campaigns found', 'psychology-help');
				} else {
					esc_html_e('No projects found', 'psychology-help');
				}
...
function psychology_help_author_avatar($template_type = 'page') {
...
/* Get Category List */
function psychology_help_get_the_category_list($cmsmasters_id, $taxonomy, $sep = '', $before = '', $after = '') {
	...
	foreach ($terms as $term) {
		...
		$links[] = '<a href="' . esc_url($link) . '" class="cmsmasters_cat_color cmsmasters_cat_' . esc_attr($term->term_id) . '" id="cmsmasters_cat_' . esc_attr($term->term_id) . '" rel="category tag">' . esc_html($term->name) . '</a>';
	}
...
if (!function_exists('psychology_help_get_post_pings')) {

function psychology_help_get_post_pings($id, $tag = 'h2') {
	$out = '';
	...
	if (pings_open($id) && sizeof($pings) > 0) {
		$out .= '<aside class="cmsmasters_pings_list">' . "\n" .
			'<' . esc_html($tag) . '>' . esc_html__('Trackbacks and Pingbacks', 'psychology-help') . '</' . esc_html($tag) . '>' . "\n" .
