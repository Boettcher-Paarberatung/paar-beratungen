...
function psychology_help_gutenberg_module_fonts($custom_css = '', $is_editor = false) {
...
/***************** Start Gutenberg Module Custom Font Styles ******************/
	...
	{$editor} .wp-block-table tbody,
	{$editor} .wp-block-freeform.mce-content-body > table tbody {
...
/***************** Start Gutenberg Module General Font Styles ******************/
	...
	{$editor} .wp-block-quote.is-large,
	{$editor} .wp-block-quote.is-style-large {
		font-size:" . ((int) $cmsmasters_option['psychology-help' . '_quote_font_font_size'] + 4) . "px;
		line-height:" . ((int) $cmsmasters_option['psychology-help' . '_quote_font_line_height'] + 4) . "px;
	}
...
add_filter('psychology_help_theme_fonts_filter', 'psychology_help_gutenberg_module_fonts');
