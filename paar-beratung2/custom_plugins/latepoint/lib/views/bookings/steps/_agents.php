<div class="step-agents-w latepoint-step-content">
  <ul class="os-agents os-animated-parent">
    ...
    <?php if(OsSettingsHelper::is_on('allow_any_agent')){ ?>
      <li class="os-animated-child">
        <a href="#" data-agent-id="<?php echo LATEPOINT_ANY_AGENT; ?>" class="os-animated-self">
    ...
    <?php foreach($agents as $agent){ ?>
      <li class="os-animated-child">
        <a href="#" data-agent-id="<?php echo $agent->id; ?>" class="os-animated-self">
