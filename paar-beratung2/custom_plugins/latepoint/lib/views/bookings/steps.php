<div class="latepoint-booking-form-element current-step-<?php echo $active_step_model->name; ?> <?php if(!$show_next_btn) echo 'hidden-buttons'; ?> latepoint-color-<?php echo OsSettingsHelper::get_booking_form_color_scheme(); ?>">
