    ...
    <div class="os-form-content">
      ...
      <div class="os-service-durations" style="<?php echo ($booking->service_id && count($booking->service->get_all_durations_arr()) > 1) ? '' : 'display: none;'; ?>">
        <div class="os-form-group os-form-select-group os-form-group-transparent">
          ...
          <select class="os-form-control" name="" id="">
            <?php if($booking->service_id){ 
                echo $booking->get_duration();
                foreach($booking->service->get_all_durations_arr() as $extra_duration){
                  $selected = ($extra_duration['duration'] == $booking->get_duration()) ? 'selected' : '';
      ...
      <div class="os-row">
        <div class="os-col-6">
          <?php echo OsFormHelper::text_field('booking[start_date]', __('Start Date', 'latepoint'), $booking->start_date, array('class' => '', 'data-route' => OsRouterHelper::build_route_name('bookings', 'quick_availability'))); ?>
        </div>
        <div class="os-col-6">
      ...
      <div class="payment-info-w">
        ...
        <div class="os-row">
          ...
          <div class="os-col-lg-6">
            <?php echo OsFormHelper::select_field('booking[payment_portion]', __('Payment Portion', 'latepoint'), [ LATEPOINT_PAYMENT_PORTION_FULL => __('Full Amount', 'latepoint'), LATEPOINT_PAYMENT_PORTION_DEPOSIT => __('Deposit', 'latepoint')], $booking->payment_portion, array('placeholder' => __('Not Applicable', 'latepoint'))); ?>
          </div>
        </div>
        <div class="os-row">
          <div class="os-col-lg-6">
