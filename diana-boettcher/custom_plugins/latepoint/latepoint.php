...
final class LatePoint {
  ...
  function add_latepoint_link_to_admin_bar( $wp_admin_bar ) {
    ...
    $args = array(
      ...
      'title' => '<span class="latepoint-icon latepoint-icon-lp-logo" style="margin-right: 7px; color:#ff2165;"></span><span style="">'.__('LatePoint', 'latepoint').'</span>',
      'href'  => $link,
      'meta'  => array( 'class' => '' )
    );
