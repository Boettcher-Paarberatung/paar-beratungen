<?php
global $jws_options;
$image_default = isset($jws_options['jws_blog_image_default']) ? $jws_options['jws_blog_image_default'] : '';
?>
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="tb-content-block">
		...
		<?php if($show_desc) echo '<div class="blog-desc">'.jws_custom_excerpt($excerpt_length , $excerpt_more).'</div>'; ?>
