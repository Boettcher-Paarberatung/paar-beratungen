...
function jws_theme_login_form_func($atts, $content = null) {
    ...
    ?>
		<div class="<?php echo esc_attr(implode(' ', $class)); ?>">
			<h5 class="tb-title"><?php esc_html_e('Login', 'medicare'); ?></h5>
			<p><?php esc_html_e('Hello, Welcome your to account', 'medicare'); ?></p>
			<div class="tb-social-login">
				<a class="tb-facebook-login" href="<?php echo esc_url($link_facebook); ?>"><i class="fa fa-facebook"></i><?php esc_html_e('Sign In With Facebook', 'medicare') ?></a>
				<a class="tb-twitter-login" href="<?php echo esc_url($link_twitter); ?>"><i class="fa fa-twitter"></i><?php esc_html_e('Sign In With Twitter', 'medicare') ?></a>
			</div>
			<?php
				$args = array(
					'echo'           => true,
					...
					'id_submit'      => 'wp-submit',
					'label_username' => esc_html__( 'Email Address', 'medicare' ),
					'label_password' => esc_html__( 'Password', 'medicare' ),
					'label_remember' => esc_html__( 'Remember me!', 'medicare' ),
					'label_log_in'   => esc_html__( 'LogIn', 'medicare' ),
					'value_username' => '',
