...
(function($) {
	...
	var MedicareObj = {
		...
		jws_theme_set_stick_bar:function( header_offset ){
			MedicareObj._header_offset = ( header_offset ) ? header_offset : ( ( MedicareObj._header_offset ) ? MedicareObj._header_offset : ( $('.tb-header-wrap .tb-header-menu').length > 0 ) ? $('.tb-header-wrap .tb-header-menu').offset() : 0 );
			if( MedicareObj._header_offset ){
				if ($(window).scrollTop() > MedicareObj._header_offset.top) {
