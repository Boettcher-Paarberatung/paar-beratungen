<?php
    ...
    if($jws_theme_header_fixed && !is_single() &&!is_search())$jws_theme_header_class[] = 'tb-header-fixed';
	/* if(is_single()){
		...
		<div class="tb-header-top">
			<?php if( ! $jws_theme_header_full ) echo '<div class="container">'; ?>
				<div class="row">
					...
					$cl_sb_top_left = '';
					$cl_sb_top_right = '';
					$top_wg1='tbtheme-header-top-widget-1';
					$top_wg2='tbtheme-header-top-widget-2';
					
					if(is_active_sidebar( $top_wg1 ) && is_active_sidebar( $top_wg2 )){
						$cl_sb_top_left = 'col-xs-12 col-sm-6 col-md-6 col-lg-6';
						$cl_sb_top_right = 'col-xs-12 col-sm-6 col-md-6 col-lg-6';
					}else{
						if(is_active_sidebar( $top_wg1 )) $cl_sb_top_left = 'col-xs-12 col-sm-12 col-md-12 col-lg-12';
						if(is_active_sidebar( $top_wg2 )) $cl_sb_top_right = 'col-xs-12 col-sm-12 col-md-12 col-lg-12';
					}
					?>
					<!-- Start Sidebar Top Left -->
					<?php if(is_active_sidebar( $top_wg1 )){ ?>
						<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
							<div class="tb-sidebar tb-sidebar-left"><?php dynamic_sidebar($top_wg1);?></div>
						</div>
					<?php } ?>
					<!-- End Sidebar Top Left -->
					<!-- Start Sidebar Top Right -->
					<?php if(is_active_sidebar( $top_wg2 )){ ?>
						<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
							<div class="tb-sidebar tb-sidebar-right"><?php dynamic_sidebar($top_wg2);?></div>
						</div>
					<?php } ?>
