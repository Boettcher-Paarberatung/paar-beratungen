		...
		<div class="row">
			<div class="tb-info-inner image1">
				...
				<div class="tb-image <?php echo esc_attr( $align_image1 );?>">
					...
					/*
					if($crop_image1)
						echo wp_get_attachment_image( $image_1, array($width_image1,$height_image1), false, array('class'=>'img-responsive') );
					else */
						echo wp_get_attachment_image( $image_1, 'full', false, array('class'=>'img-responsive') );?>
				</div>
			</div>
