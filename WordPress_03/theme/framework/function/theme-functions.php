...
/* Register CSS Styles */
function psychology_help_register_css_styles() {
	if (!is_admin()) {
		global $post, 
			$wp_styles;
		...
		// iLightBox skins
		$ilightbox_skin = $cmsmasters_option['psychology-help' . '_ilightbox_skin'];
		...
		if (is_dir($style_dir) && get_option('cmsmasters_style_exists_' . 'psychology-help')) {
		...
		if (
			...
			wp_enqueue_style('theme-fonts-schemes', $cmsmasters_styles_dir . 'psychology-help' . '.css', array(), '1.0.0', 'screen');
		}
		
		
		wp_enqueue_style('theme-fonts', $cmsmasters_styles_dir . 'psychology-help' . '_fonts.css', array(), '1.0.0', 'screen');
		
		wp_enqueue_style('theme-schemes-primary', $cmsmasters_styles_dir . 'psychology-help' . '_colors_primary.css', array(), '1.0.0', 'screen');
		
		wp_enqueue_style('theme-schemes-secondary', $cmsmasters_styles_dir . 'psychology-help' . '_colors_secondary.css', array(), '1.0.0', 'screen');
...
add_action('wp_enqueue_scripts', 'psychology_help_register_css_styles');



/* Register JS Scripts */
function psychology_help_register_js_scripts() {
	if (!is_admin()) {
		global $post;
		...
		wp_localize_script('jLibs', 'cmsmasters_jlibs', array( 
			'button_height' => 	(is_admin_bar_showing() ? 32 : 0) - ($cmsmasters_option['psychology-help' . '_button_font_line_height'] / 2)
		));
		...
		$primary_color = $cmsmasters_option['psychology-help' . '_default_link'];
		...
		wp_localize_script('script', 'cmsmasters_script', array( 
			...
			'ilightbox_skin' => 					$cmsmasters_option['psychology-help' . '_ilightbox_skin'], 
			'ilightbox_path' => 					$cmsmasters_option['psychology-help' . '_ilightbox_path'], 
			'ilightbox_infinite' => 				$cmsmasters_option['psychology-help' . '_ilightbox_infinite'], 
			'ilightbox_aspect_ratio' => 			$cmsmasters_option['psychology-help' . '_ilightbox_aspect_ratio'], 
			'ilightbox_mobile_optimizer' => 		$cmsmasters_option['psychology-help' . '_ilightbox_mobile_optimizer'], 
			'ilightbox_max_scale' => 				$cmsmasters_option['psychology-help' . '_ilightbox_max_scale'], 
			'ilightbox_min_scale' => 				$cmsmasters_option['psychology-help' . '_ilightbox_min_scale'], 
			'ilightbox_inner_toolbar' => 			$cmsmasters_option['psychology-help' . '_ilightbox_inner_toolbar'], 
			'ilightbox_smart_recognition' => 		$cmsmasters_option['psychology-help' . '_ilightbox_smart_recognition'], 
			'ilightbox_fullscreen_one_slide' => 	$cmsmasters_option['psychology-help' . '_ilightbox_fullscreen_one_slide'], 
			'ilightbox_fullscreen_viewport' => 		$cmsmasters_option['psychology-help' . '_ilightbox_fullscreen_viewport'], 
			'ilightbox_controls_toolbar' => 		$cmsmasters_option['psychology-help' . '_ilightbox_controls_toolbar'], 
			'ilightbox_controls_arrows' => 			$cmsmasters_option['psychology-help' . '_ilightbox_controls_arrows'], 
			'ilightbox_controls_fullscreen' => 		$cmsmasters_option['psychology-help' . '_ilightbox_controls_fullscreen'], 
			'ilightbox_controls_thumbnail' => 		$cmsmasters_option['psychology-help' . '_ilightbox_controls_thumbnail'], 
			'ilightbox_controls_keyboard' => 		$cmsmasters_option['psychology-help' . '_ilightbox_controls_keyboard'], 
			'ilightbox_controls_mousewheel' => 		$cmsmasters_option['psychology-help' . '_ilightbox_controls_mousewheel'], 
			'ilightbox_controls_swipe' => 			$cmsmasters_option['psychology-help' . '_ilightbox_controls_swipe'], 
			'ilightbox_controls_slideshow' => 		$cmsmasters_option['psychology-help' . '_ilightbox_controls_slideshow'], 
			'ilightbox_close_text' => 				esc_html__('Close', 'psychology-help'), 
			'ilightbox_enter_fullscreen_text' => 	esc_html__('Enter Fullscreen (Shift+Enter)', 'psychology-help'), 
			'ilightbox_exit_fullscreen_text' => 	esc_html__('Exit Fullscreen (Shift+Enter)', 'psychology-help'), 
			'ilightbox_slideshow_text' => 			esc_html__('Slideshow', 'psychology-help'), 
			'ilightbox_next_text' => 				esc_html__('Next', 'psychology-help'), 
			'ilightbox_previous_text' => 			esc_html__('Previous', 'psychology-help'), 
			'ilightbox_load_image_error' => 		esc_html__('An error occurred when trying to load photo.', 'psychology-help'), 
			'ilightbox_load_contents_error' => 		esc_html__('An error occurred when trying to load contents.', 'psychology-help'), 
			'ilightbox_missing_plugin_error' => 	esc_html__("The content your are attempting to view requires the <a href='{pluginspage}' target='_blank'>{type} plugin<\/a>.", 'psychology-help') 
		));
		...
		if ( 
			...
			wp_enqueue_script('gMapAPI', '//maps.googleapis.com/maps/api/js?key=' . $cmsmasters_option['psychology-help' . '_gmap_api_key'], array('jquery'), '1.0.0', true);
...
add_action('wp_enqueue_scripts', 'psychology_help_register_js_scripts');



/* Developer Mode */
function psychology_help_developer_mode() {
...
add_action('wp_enqueue_scripts', 'psychology_help_developer_mode');



/* Google Fonts Generate Function */
if (!function_exists('psychology_help_theme_google_fonts_generate')) {

function psychology_help_theme_google_fonts_generate() {
	$cmsmasters_option = psychology_help_get_global_options();
	...
	foreach (cmsmasters_google_fonts_list() as $key => $value) {
		if ( 
			(isset($cmsmasters_option['psychology-help' . '_content_font_google_font']) && $key == $cmsmasters_option['psychology-help' . '_content_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['psychology-help' . '_link_font_google_font']) && $key == $cmsmasters_option['psychology-help' . '_link_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['psychology-help' . '_nav_title_font_google_font']) && $key == $cmsmasters_option['psychology-help' . '_nav_title_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['psychology-help' . '_nav_dropdown_font_google_font']) && $key == $cmsmasters_option['psychology-help' . '_nav_dropdown_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['psychology-help' . '_h1_font_google_font']) && $key == $cmsmasters_option['psychology-help' . '_h1_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['psychology-help' . '_h2_font_google_font']) && $key == $cmsmasters_option['psychology-help' . '_h2_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['psychology-help' . '_h3_font_google_font']) && $key == $cmsmasters_option['psychology-help' . '_h3_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['psychology-help' . '_h4_font_google_font']) && $key == $cmsmasters_option['psychology-help' . '_h4_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['psychology-help' . '_h5_font_google_font']) && $key == $cmsmasters_option['psychology-help' . '_h5_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['psychology-help' . '_h6_font_google_font']) && $key == $cmsmasters_option['psychology-help' . '_h6_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['psychology-help' . '_button_font_google_font']) && $key == $cmsmasters_option['psychology-help' . '_button_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['psychology-help' . '_small_font_google_font']) && $key == $cmsmasters_option['psychology-help' . '_small_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['psychology-help' . '_input_font_google_font']) && $key == $cmsmasters_option['psychology-help' . '_input_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['psychology-help' . '_quote_font_google_font']) && $key == $cmsmasters_option['psychology-help' . '_quote_font_google_font'] && $key != '') 
		) {
			$keys[] = $key;
		}
	}
...
add_action('wp_enqueue_scripts', 'psychology_help_theme_google_fonts_generate');
add_action('enqueue_block_editor_assets', 'psychology_help_theme_google_fonts_generate');
...
function psychology_help_get_google_font($font) {
	if ($font != '') {
		if (strpos($font, ':')) {
...
function psychology_help_the_widgets_init() {
    ...
    register_sidebar(
        array(
            'name' => esc_html__('Sidebar', 'psychology-help'), 
            'id' => 'sidebar_default', 
            'description' => esc_html__('Widgets in this area will be shown in all left and right sidebars till you don\'t use custom sidebar.', 'psychology-help'), 
    ...
    register_sidebar(
        array(
            'name' => esc_html__('Bottom Sidebar', 'psychology-help'), 
            'id' => 'sidebar_bottom', 
            'description' => esc_html__('Widgets in this area will be shown at the bottom of middle block below the content and middle sidebar, but above footer.', 'psychology-help'), 
            'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
            'after_widget' => '</aside>', 
            'before_title' => '<h3 class="widgettitle">', 
            'after_title' => '</h3>'
    ...
    register_sidebar(
        array(
            'name' => esc_html__('Archive Sidebar', 'psychology-help'), 
            'id' => 'sidebar_archive', 
            'description' => esc_html__('Widgets in this area will be shown in all left and right sidebars on archives pages.', 'psychology-help'), 
            'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
            'after_widget' => '</aside>', 
            'before_title' => '<h3 class="widgettitle">', 
            'after_title' => '</h3>'
    ...
    register_sidebar(
        array(
            'name' => esc_html__('Search Sidebar', 'psychology-help'), 
            'id' => 'sidebar_search', 
            'description' => esc_html__('Widgets in this area will be shown in left or right sidebar on search page.', 'psychology-help'), 
            'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
            'after_widget' => '</aside>', 
            'before_title' => '<h3 class="widgettitle">', 
            'after_title' => '</h3>'
	...
	if (isset($cmsmasters_option['psychology-help' . '_sidebar']) && sizeof($cmsmasters_option['psychology-help' . '_sidebar']) > 0) {
		foreach ($cmsmasters_option['psychology-help' . '_sidebar'] as $sidebar) {
			register_sidebar(array( 
				'name' => $sidebar, 
				'id' => generateSlug($sidebar, 45), 
				'description' => esc_html__('Custom sidebar created with cmsmasters admin panel.', 'psychology-help'), 
				'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
				'after_widget' => '</aside>', 
				'before_title' => '<h3 class="widgettitle">', 
				'after_title' => '</h3>' 
...
add_action('widgets_init', 'psychology_help_the_widgets_init');



/* Register Theme Navigations */
register_nav_menus(array( 
    'primary' => 	esc_html__('Primary Navigation', 'psychology-help'), 
    'footer' => 	esc_html__('Footer Navigation', 'psychology-help'), 
	'top_line' => 	esc_html__('Top Line Navigation', 'psychology-help') 
));



/* Register Showing Home Page on Default WordPress Pages Menu */
function psychology_help_page_menu_args($args) {
    $args['show_home'] = true;
...
add_filter('wp_page_menu_args', 'psychology_help_page_menu_args');
...
function psychology_help_fallback_menu($args) {
	$cmsmasters_option = psychology_help_get_global_options();
	...
	echo '<div class="navigation_wrap">' . "\n" . 
		'<ul id="navigation" class="' . 
			'navigation ' . 
			($cmsmasters_option['psychology-help' . '_header_styles'] == 'default' ? 'mid_nav' : 'bot_nav') . 
		'">' . "\n";
...
if (function_exists('add_theme_support')) {
	...
	function psychology_help_add_post_type_support_project($post) {
	...
	add_action('load-post.php', 'psychology_help_add_post_type_support_project');
	
	add_action('load-post-new.php', 'psychology_help_add_post_type_support_project');
	
	
	// Add post-formats to post_type 'project'
	function psychology_help_add_post_formats_to_project() {
		add_post_type_support('project', 'post-formats');
		
		register_taxonomy_for_object_type('post_format', 'project');
	}
	
	add_action('init', 'psychology_help_add_post_formats_to_project', 11);
	...
	add_filter('image_size_names_choose', 'psychology_help_select_image_size');
}



/* Add Image Thumbnails Size to the List */
function psychology_help_select_image_size($sizes) {
	$thumbnail_list = cmsmasters_image_thumbnail_list();
...
function psychology_help_add_editor_styles() {
...
if (version_compare($cmsmasters_wp_version, '5', '<') && !function_exists('is_gutenberg_page')) {
	add_action('init', 'psychology_help_add_editor_styles');
}


/* Register Removing 'More Text' From Excerpt */
function psychology_help_new_excerpt_more($more) {
	return '...';
}

add_filter('excerpt_more', 'psychology_help_new_excerpt_more');
...
function psychology_help_post_author_archive($query) {
...
add_action('pre_get_posts', 'psychology_help_post_author_archive');



/* Check Row p Wrapper */
function psychology_help_rowcheck($content) {
...
function psychology_help_add_global_icons() {
	...
	if ($wp_filesystem) {
		...
		update_option('cmsmasters_' . 'psychology-help' . '_icons', serialize($arr));
		
		update_option('cmsmasters_' . 'psychology-help' . '_icons_custom', serialize($arr_custom));
	}
}
...
function cmsmasters_composer_icons() {
	$icons = get_option('cmsmasters_' . 'psychology-help' . '_icons');
	
	$icons_custom = get_option('cmsmasters_' . 'psychology-help' . '_icons_custom');
...
function psychology_help_regenerate_styles() {
	$custom_css_fonts = psychology_help_theme_fonts();
	
	$custom_css_colors_primary = psychology_help_theme_colors_primary();
	
	$custom_css_colors_secondary = psychology_help_theme_colors_secondary();
	
	
	$custom_css = $custom_css_fonts . $custom_css_colors_primary . $custom_css_colors_secondary;
	
	
	psychology_help_write_styles($custom_css_fonts, 'psychology-help' . '_fonts');
	
	psychology_help_write_styles($custom_css_colors_primary, 'psychology-help' . '_colors_primary');
	
	psychology_help_write_styles($custom_css_colors_secondary, 'psychology-help' . '_colors_secondary');
	
	
	psychology_help_write_styles($custom_css);
}
...
function psychology_help_write_styles($styles, $filename = '') {
	$upload_dir = wp_upload_dir();
	...
	$is_dir = psychology_help_create_folder($style_dir);
	
	
	if ($is_dir === false) {
		update_option('cmsmasters_style_dir_writable_' . 'psychology-help', 'false');
		
		update_option('cmsmasters_style_exists_' . 'psychology-help', 'false');
	...
	$file = trailingslashit($style_dir) . (($filename != '') ? $filename : 'psychology-help') . '.css';
	
	
	$created = psychology_help_create_file($file, $styles);
	
	
	if ($created === true) {
		update_option('cmsmasters_style_dir_writable_' . 'psychology-help', 'true');
		
		update_option('cmsmasters_style_exists_' . 'psychology-help', 'true');
	}
}
...
function psychology_help_create_folder(&$folder, $addindex = true) {
...
function psychology_help_create_file($file, $content = '', $verifycontent = true) {
	global $wp_filesystem;
...
function cmsmasters_get_tweets($username, $count) {
	...
	psychology_help_locate_template(CMSMASTERS_CONTENT_COMPOSER_PATH . 'inc/twitter//OAuth.php', true);
	...
	$numTweets = $count;
	$cacheTime = 1;
	$backupName = 'cmsmasters_' . 'psychology-help' . '_tweets_list_backup';
	
	
	$connection = new TwitterOAuth( 
		(($cmsmasters_option['psychology-help' . '_api_key'] != '') ? $cmsmasters_option['psychology-help' . '_api_key'] : ''), 
		(($cmsmasters_option['psychology-help' . '_api_secret'] != '') ? $cmsmasters_option['psychology-help' . '_api_secret'] : ''), 
		(($cmsmasters_option['psychology-help' . '_access_token'] != '') ? $cmsmasters_option['psychology-help' . '_access_token'] : ''), 
		(($cmsmasters_option['psychology-help' . '_access_token_secret'] != '') ? $cmsmasters_option['psychology-help' . '_access_token_secret'] : '')
	);
...
function psychology_help_theme_header_styles() {
	$cmsmasters_option = psychology_help_get_global_options();
	
	
	$header_top_height = (($cmsmasters_option['psychology-help' . '_header_top_height'] !== '') ? $cmsmasters_option['psychology-help' . '_header_top_height'] : '40');
	
	$header_mid_height = (($cmsmasters_option['psychology-help' . '_header_mid_height'] !== '') ? $cmsmasters_option['psychology-help' . '_header_mid_height'] : '100');
	
	$header_bot_height = (($cmsmasters_option['psychology-help' . '_header_bot_height'] !== '') ? $cmsmasters_option['psychology-help' . '_header_bot_height'] : '55');
	...
	.cmsmasters_dynamic_cart {
		margin-top : " . (($header_mid_height / 2) + $header_top_height + (is_admin_bar_showing() ? 32 : 0) - ($cmsmasters_option['psychology-help' . '_button_font_line_height'] / 2)) . "px;
	}
	
	.cmsmasters_dynamic_cart .widget_shopping_cart_content, 
	.cmsmasters_added_product_info {
		margin-top : " . ($cmsmasters_option['psychology-help' . '_button_font_line_height'] + 20) . "px;
	}
	...
	@media only screen and (max-width: 1200px) {
		.cmsmasters_dynamic_cart {
			margin-top : " . ($header_mid_height + $header_top_height + (is_admin_bar_showing() ? 32 : 0) - ($cmsmasters_option['psychology-help' . '_button_font_line_height'] / 2)) . "px !important;
		}
	}
";
	
	
	if ($cmsmasters_option['psychology-help' . '_logo_type'] == 'text' && $cmsmasters_option['psychology-help' . '_logo_custom_color']) {
		$out .= "
	#header a.logo span.title {
		" . cmsmasters_color_css('color', $cmsmasters_option['psychology-help' . '_logo_title_color']) . "
	}
	
	#header a.logo span.title_text {
		" . cmsmasters_color_css('color', $cmsmasters_option['psychology-help' . '_logo_subtitle_color']) . "
	}
";
	}
	...
	if (is_404()) {
		if (
			$cmsmasters_option['psychology-help' . '_error_bg_img_enable'] && 
			$cmsmasters_option['psychology-help' . '_error_bg_image'] != ''
		) {
			$error_bg_image = explode('|', $cmsmasters_option['psychology-help' . '_error_bg_image']);
	...
	.error_page .content_wrap {
		background-image : " . (!empty($cmsmasters_option['psychology-help' . '_error_bg_image']) ? 'url(' . ((is_numeric($error_bg_image[0])) ? $error_bg_image_url[0] : $error_bg_image[1]) . ')' : 'none') . ";
		background-position : " . (!empty($cmsmasters_option['psychology-help' . '_error_bg_pos']) ? $cmsmasters_option['psychology-help' . '_error_bg_pos'] : 'top center') . ";
		background-repeat : " . (!empty($cmsmasters_option['psychology-help' . '_error_bg_rep']) ? $cmsmasters_option['psychology-help' . '_error_bg_rep'] : 'repeat') . ";
		background-attachment : " . (!empty($cmsmasters_option['psychology-help' . '_error_bg_att']) ? $cmsmasters_option['psychology-help' . '_error_bg_att'] : 'scroll') . ";
		background-size : " . (!empty($cmsmasters_option['psychology-help' . '_error_bg_size']) ? $cmsmasters_option['psychology-help' . '_error_bg_size'] : 'auto') . ";
	}
";
		}
		...
		$out .= "
	.error_page .content_wrap {
		" . cmsmasters_color_css('background-color', $cmsmasters_option['psychology-help' . '_error_bg_color']) . "
	}
	
	.error_title,
	.error_subtitle {
		" . cmsmasters_color_css('color', $cmsmasters_option['psychology-help' . '_error_color']) . "
	}
";
	}
	
	
	if ($cmsmasters_option['psychology-help' . '_custom_css'] != '') {
		$out .= stripslashes($cmsmasters_option['psychology-help' . '_custom_css']);
	}
...
function psychology_help_theme_bg_styles() {
	global $post;
	...
	if ($cmsmasters_option['psychology-help' . '_theme_layout'] == 'boxed') {
		...
		if ($cmsmasters_bg_default == 'false') {
			...
			$cmsmasters_bg_col = $cmsmasters_option['psychology-help' . '_bg_col'];
			$cmsmasters_bg_img_enable = $cmsmasters_option['psychology-help' . '_bg_img_enable'];
			$cmsmasters_bg_img_str = $cmsmasters_option['psychology-help' . '_bg_img'];
			$cmsmasters_bg_pos = $cmsmasters_option['psychology-help' . '_bg_pos'];
			$cmsmasters_bg_rep = $cmsmasters_option['psychology-help' . '_bg_rep'];
			$cmsmasters_bg_att = $cmsmasters_option['psychology-help' . '_bg_att'];
			$cmsmasters_bg_size = $cmsmasters_option['psychology-help' . '_bg_size'];
		}
...
/* Theme Custom Styles */
function psychology_help_theme_custom_styles() {
	echo '<style type="text/css">' . 
		psychology_help_theme_header_styles() . 
		psychology_help_theme_bg_styles() .  
		psychology_help_theme_logo_styles() . 
		psychology_help_theme_page_heading_styles() . 
	'</style>';
}

add_action('wp_head', 'psychology_help_theme_custom_styles');



/* Theme Footer Scripts Function */
function psychology_help_theme_footer_scripts() {
	$cmsmasters_option = psychology_help_get_global_options();
	
	
	if ($cmsmasters_option['psychology-help' . '_custom_js'] != '') {
		echo "
<script type=\"text/javascript\">
	" . stripslashes($cmsmasters_option['psychology-help' . '_custom_js']) . "
</script>
";
	}
}

add_action('wp_print_footer_scripts', 'psychology_help_theme_footer_scripts');



/* Theme Page Layout and Scheme Function */
function psychology_help_theme_page_layout_scheme() {
	$cmsmasters_option = psychology_help_get_global_options();
	...
	} elseif (CMSMASTERS_EVENTS_CALENDAR && tribe_is_event_query() && isset($cmsmasters_option['psychology-help' . '_events_layout'])) {
		$cmsmasters_layout = $cmsmasters_option['psychology-help' . '_events_layout'];
	} elseif (is_archive() || is_home()) {
		$cmsmasters_layout = $cmsmasters_option['psychology-help' . '_archives_layout'];
	} elseif (is_search()) {
		$cmsmasters_layout = $cmsmasters_option['psychology-help' . '_search_layout'];
	} else {
		$cmsmasters_layout = $cmsmasters_option['psychology-help' . '_other_layout'];
	}
	
	
	if ($cmsmasters_layout == '') {
		$cmsmasters_layout = $cmsmasters_option['psychology-help' . '_layout'];
	}
...
/* Return content */
function psychology_help_return_content($content) {
	return $content;
}
...
function psychology_help_global_shortcodes_styles_move($content) {
...
add_filter('the_content', 'psychology_help_global_shortcodes_styles_move', 11, 2);
add_filter('widget_text_content', 'psychology_help_global_shortcodes_styles_move', 11, 3);


function psychology_help_row_checker($data) {
	$out = psychology_help_rowcheck($data);
	
	return $out;
}

add_filter('the_content', 'psychology_help_row_checker', 10, 2);



/* Project Post Type Registration Rename */
function psychology_help_project_labels () {
	return array( 
		'name' => 					esc_html__('Projects', 'psychology-help'), 
		'singular_name' => 			esc_html__('Project', 'psychology-help'), 
		'menu_name' => 				esc_html__('Projects', 'psychology-help'), 
		'all_items' => 				esc_html__('All Projects', 'psychology-help'), 
		'add_new' => 				esc_html__('Add New', 'psychology-help'), 
		'add_new_item' => 			esc_html__('Add New Project', 'psychology-help'), 
		'edit_item' => 				esc_html__('Edit Project', 'psychology-help'), 
		'new_item' => 				esc_html__('New Project', 'psychology-help'), 
		'view_item' => 				esc_html__('View Project', 'psychology-help'), 
		'search_items' => 			esc_html__('Search Projects', 'psychology-help'), 
		'not_found' => 				esc_html__('No projects found', 'psychology-help'), 
		'not_found_in_trash' => 	esc_html__('No projects found in Trash', 'psychology-help') 
	);
}

// add_filter('cmsmasters_project_labels_filter', 'psychology_help_project_labels');


function psychology_help_pj_categs_labels () {
	return array( 
		'name' => 					esc_html__('Project Categories', 'psychology-help'), 
		'singular_name' => 			esc_html__('Project Category', 'psychology-help') 
	);
}

// add_filter('cmsmasters_pj_categs_labels_filter', 'psychology_help_pj_categs_labels');


function psychology_help_pj_tags_labels () {
	return array( 
		'name' => 					esc_html__('Project Tags', 'psychology-help'), 
		'singular_name' => 			esc_html__('Project Tag', 'psychology-help') 
	);
}

// add_filter('cmsmasters_pj_tags_labels_filter', 'psychology_help_pj_tags_labels');



/* Profile Post Type Registration Rename */
function psychology_help_profile_labels () {
	return array( 
		'name' => 					esc_html__('Profiles', 'psychology-help'), 
		'singular_name' => 			esc_html__('Profiles', 'psychology-help'), 
		'menu_name' => 				esc_html__('Profiles', 'psychology-help'), 
		'all_items' => 				esc_html__('All Profiles', 'psychology-help'), 
		'add_new' => 				esc_html__('Add New', 'psychology-help'), 
		'add_new_item' => 			esc_html__('Add New Profile', 'psychology-help'), 
		'edit_item' => 				esc_html__('Edit Profile', 'psychology-help'), 
		'new_item' => 				esc_html__('New Profile', 'psychology-help'), 
		'view_item' => 				esc_html__('View Profile', 'psychology-help'), 
		'search_items' => 			esc_html__('Search Profiles', 'psychology-help'), 
		'not_found' => 				esc_html__('No Profiles found', 'psychology-help'), 
		'not_found_in_trash' => 	esc_html__('No Profiles found in Trash', 'psychology-help') 
	);
}

// add_filter('cmsmasters_profile_labels_filter', 'psychology_help_profile_labels');


function psychology_help_pl_categs_labels () {
	return array( 
		'name' => 					esc_html__('Profile Categories', 'psychology-help'), 
		'singular_name' => 			esc_html__('Profile Category', 'psychology-help') 
	);
}

// add_filter('cmsmasters_pl_categs_labels_filter', 'psychology_help_pl_categs_labels');
...
function cmsmasters_ajax_export_settings_callback() {
	...
	if( wp_verify_nonce($nonce, 'cmsmasters_ajax_export_settings-nonce') ){
		...
		$cmsmasters_global_settings = array( 
			'cmsmasters_options_' . 'psychology-help' . '_general', 
			'cmsmasters_options_' . 'psychology-help' . '_bg', 
			'cmsmasters_options_' . 'psychology-help' . '_header', 
			'cmsmasters_options_' . 'psychology-help' . '_content', 
			'cmsmasters_options_' . 'psychology-help' . '_footer', 
			'cmsmasters_options_' . 'psychology-help' . '_font_content', 
			'cmsmasters_options_' . 'psychology-help' . '_font_link', 
			'cmsmasters_options_' . 'psychology-help' . '_font_nav', 
			'cmsmasters_options_' . 'psychology-help' . '_font_heading', 
			'cmsmasters_options_' . 'psychology-help' . '_font_other', 
			'cmsmasters_options_' . 'psychology-help' . '_element_sidebar', 
			'cmsmasters_options_' . 'psychology-help' . '_element_icon', 
			'cmsmasters_options_' . 'psychology-help' . '_element_lightbox', 
			'cmsmasters_options_' . 'psychology-help' . '_element_sitemap', 
			'cmsmasters_options_' . 'psychology-help' . '_element_error', 
			'cmsmasters_options_' . 'psychology-help' . '_element_code', 
			'cmsmasters_options_' . 'psychology-help' . '_element_recaptcha', 
			'cmsmasters_options_' . 'psychology-help' . '_single_post', 
			'cmsmasters_options_' . 'psychology-help' . '_single_project', 
			'cmsmasters_options_' . 'psychology-help' . '_single_profile'
		);
		...
		foreach (psychology_help_all_color_schemes_list() as $key => $value) {
			$cmsmasters_global_colors[] = 'cmsmasters_options_' . 'psychology-help' . '_color_' . $key;
		}
		...
		echo psychology_help_return_content($result);
