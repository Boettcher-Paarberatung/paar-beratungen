...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php 
		psychology_help_thumb_rollover(get_the_ID(), 'cmsmasters-project-thumb', true, true, true, $cmsmasters_project_images, false, false, false, false, true, $cmsmasters_project_link_redirect, $cmsmasters_project_link_url, $cmsmasters_project_link_target);
		...
		if ($title || $categories || $excerpt || $likes || $comments) {
			echo '<div class="slider_project_inner">';
				...
				($excerpt && psychology_help_slider_post_check_exc_cont('project')) ? psychology_help_slider_post_exc_cont('project') : '';
