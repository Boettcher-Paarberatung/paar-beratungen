...
function psychology_help_admin_register($hook) {
	...
	wp_localize_script('cmsmasters-uploader-js', 'cmsmasters_admin_uploader', array( 
		'choose' => 				esc_attr__('Choose image', 'psychology-help'), 
		'insert' => 				esc_attr__('Insert image', 'psychology-help'), 
		'remove' => 				esc_attr__('Remove', 'psychology-help'), 
		'edit_gallery' => 			esc_attr__('Edit gallery', 'psychology-help') 
	));
	...
	wp_localize_script('cmsmasters-lightbox-js', 'cmsmasters_admin_lightbox', array( 
		'cancel' => 				esc_attr__('Cancel', 'psychology-help'), 
		'insert' => 				esc_attr__('Insert', 'psychology-help'), 
		'deselect' => 				esc_attr__('Deselect', 'psychology-help'), 
		'choose_icon' => 			esc_attr__('Choose Icon', 'psychology-help'), 
		'find_icons' => 			esc_attr__('Find icons', 'psychology-help'), 
		'min_length' => 			esc_attr__('min 2 symbols', 'psychology-help'), 
		'choose_font' => 			esc_attr__('Choose icons font', 'psychology-help'), 
		'error_on_page' => 			esc_attr__("Error on page!\nReload page and try again.", 'psychology-help') 
	));
...
add_action('admin_enqueue_scripts', 'psychology_help_admin_register');
