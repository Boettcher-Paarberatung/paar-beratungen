...
function psychology_help_get_admin_page() {
	global $pagenow;
...
function psychology_help_default_tab() {
	$current_page = psychology_help_get_admin_page();
...
function psychology_help_get_the_tab() {
	global $pagenow;
	
	$default_tab = psychology_help_default_tab();
...
function psychology_help_settings_page_header() {
