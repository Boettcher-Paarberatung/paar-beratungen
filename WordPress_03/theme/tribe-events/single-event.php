...
<div id="tribe-events-content" class="tribe-events-single vevent hentry">
	<div id="post-<?php the_ID(); ?>" <?php post_class('cmsmasters_single_event'); ?>>
		<div class="cmsmasters_single_event_header clearfix">
			...
			<?php 
				echo '<div class="cmsmasters_single_event_header_left_inner">';
			...
			<div class="cmsmasters_single_event_header_right clearfix">
				<div class="tribe-events-back">
					<a href="<?php echo esc_url( tribe_get_events_link() ); ?>" class="cmsmasters_events_calendar"> <?php printf( __( ' All %s', 'psychology-help' ), $events_label_plural ); ?></a>
				</div>
