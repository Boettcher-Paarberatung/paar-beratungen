...
/* Replace Styles */
function psychology_help_replace_tribe_events_calendar_stylesheet() {
...
add_action('wp_enqueue_scripts', 'psychology_help_replace_tribe_events_calendar_stylesheet', 100);


/* Replace Pro Styles */
function psychology_help_replace_tribe_events_calendar_pro_stylesheet() {
...
add_action('wp_enqueue_scripts', 'psychology_help_replace_tribe_events_calendar_pro_stylesheet', 100);
