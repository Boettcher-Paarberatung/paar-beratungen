...
<div id="page" class="<?php psychology_help_get_page_classes($cmsmasters_option); ?>hfeed site">
...
<header id="header">
	<?php 
	psychology_help_header_top($cmsmasters_option);
	
	
	psychology_help_header_mid($cmsmasters_option); 
	
	
	psychology_help_header_bot($cmsmasters_option);
	?>
</header>
...
list($cmsmasters_layout, $cmsmasters_page_scheme) = psychology_help_theme_page_layout_scheme();
