...
if ($button_show == 'true') {
	...
	if ($button_custom_styles == 'true') {
		...
		$this->pricing_table_items_atts['style_pricing'] .= '#cmsmasters_pricing_item_' . $unique_id . ' .cmsmasters_button:before, #cmsmasters_pricing_item_' . $unique_id . ' .cmsmasters_button:after { ' . 
...
echo psychology_help_return_content($price_out);
