...
class OsGoogleCalendarHelper {
  ...
  public static function translate_weekdays($weekday){
    ...
    return str_replace(['MO', 'TU', 'WE', 'TH', 'FR', 'SA', 'SU'], [__('Mon', 'latepoint'), __('Tue', 'latepoint'), __('Wed', 'latepoint'), __('Thu', 'latepoint'), __('Fri', 'latepoint'), __('Sat', 'latepoint'), __('Sun', 'latepoint')], $weekday);
  }
  ...
  public static function create_or_update_booking_in_gcal($booking_id){
    ...
    if($g_client){
      ...
      if($booking->status == LATEPOINT_BOOKING_STATUS_APPROVED){
        ...
        $description = __('Customer Name: ', 'latepoint').$booking->customer->full_name."\r\n";
